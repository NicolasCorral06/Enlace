...
<body>    
    <?php
        ...
        $manager = new Manager();
        $dados = $manager->admChamadoListar();
    ...
    <table>
        ...
        <?php
            for($i = 1; $i <= $dados["num"]; $i++){
                ...
                echo "<td>" . $dados[$i]["email_adm"] . "</td>";
                echo "<td>";
                if ($dados[$i]["assunto"] == 1) {
                    echo "Mudança de senha";
                } elseif($dados[$i]["assunto"] == 2) {
                    echo "Mudança de status";
                } elseif($dados[$i]["assunto"] == 3) {
                    echo "Mudança de poder";
                } else{
                    echo "Outro";
                }
                echo "</td>";
                ...
                echo "<td>";
                ?>
                    <a href="#" data-toggle="modal" data-target="#assunto<?= $dados[$i]["id"] . $dados[$i]["assunto"] ?>"> Atualizar </a>
                <?php
                echo "</td>";
                echo "<td>";
                ?>
                ...
                ?>
                    <div class="modal fade" id="assunto<?= $dados[$i]["id"] . $dados[$i]["assunto"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <p id="textomodal">
                                <form action="../Controller/controller.php" method="POST">
                                    ...
                                    if ($dados[$i]["assunto"] == 1) {
                                        ?>
                                        <input type="hidden" name="mudarSenhaChamado" value="1">
                                        <input type="hidden" name="emailAdm" value="<?= $dados[$i]["email_adm"] ?>">
                                        <input type="hidden" name="assunto" value="<?= $dados[$i]["assunto"] ?>">
                                        <input type="hidden" name="idAdm" value="<?= $dados[$i]["id"] ?>">

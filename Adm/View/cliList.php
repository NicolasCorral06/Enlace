...
input[type="text"]:focus, input[type="email"]:focus, textarea:focus {
    ...
    <script>
        function confirmDelete(id) {
            ...
            if (resp == true) {
                location.href = "../Controller/controller.php?cli_delete=1&id=" + id;
            } else {
                return null;
            }
        }
...
<body>
    <form action="cliNew.php" method="post">
    ...
    <table>
        ...
        <?php
            for($i = 1; $i <= $dados["num"]; $i++){
                ...
                echo "<td>";
                if($dados[$i]["foto_perfil"] != ""){
                    echo "<img src='../../Assets/Cliente/" . $dados[$i]["foto_perfil"] . "' width='50' height='50' alt='foto do cliente'>";
                } else {
                    echo "Usuário sem foto";
                }
                ...
                echo "<td>" . date("d/m/Y", strtotime($dados[$i]["nascimento"])) . "</td>";
                ...
                echo "<td>";
                ?>
                    <form name="formEdit" action="cliEdit.php" method="post">

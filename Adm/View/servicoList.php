...
input[type="text"]:focus, input[type="email"]:focus, textarea:focus {
    ...
    <script>
        function confirmDelete(id) {
            ...
            if (resp == true) {
                location.href = "../Controller/controller.php?servico_delete=1&id=" + id;
            } else {
                return null;
            }
        }
...
<body>
    <form action="servicoNew.php" method="post">
    ...
    <table>
        ...
        <?php
            for($i = 1; $i <= $dados["num"]; $i++){
                ...
                echo "<td>" . $dados[$i]["sobre"] . "</td>";
                echo "<td>" . $dados[$i]["serve"] . "</td>";
                ...
                echo "<td>";
                ?>
                    <form name="formEdit" action="servicoEdit.php" method="post">
    ...
    <?php
        ...
        echo "<br> Nenhum serviço encontrado!";
    }
    ?>

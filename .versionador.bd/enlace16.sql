...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Nov-2024 às 13:25
...
(7, 1, 1, 1, '180.00', 1, 2, 'São Paulo', '12:15:00', '9J2WITPnD', '2024-11-30', '2024-11-29 09:15:27', 2);

-- --------------------------------------------------------

--
-- Estrutura da tabela `agendamentolocal`
--
...
--
-- Extraindo dados da tabela `agendamentolocal`
--
...
--
-- Estrutura da tabela `chamado_adm`
--
...
--
-- Extraindo dados da tabela `chamado_adm`
--
...
(1, 'fp_1732827157.jpg', 'Nicolás Corral', 'nico@gmail.com', '556d7dc3a115356350f1f9910b1af1ab0e312d4b3e4fc788d2da63668f36d017', '(54) 54545-4545', '2024-08-02', '888.888.888-88', '2024-01-21 11:37:28', 1),
...
--
-- Extraindo dados da tabela `cli_mudarsenha`
--
...
(5, 1, 6, 3, 'mais ou menos', '2024-11-29 08:35:00', 1);
...
--
-- Estrutura da tabela `int_mudarsenha`
--
...
--
-- Índices para tabela `agendamentolocal`
--
...
--
-- Índices para tabela `chamado_adm`
--
...
--
-- Índices para tabela `int_mudarsenha`
--

...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Out-2024 às 14:26
...
(1, 'Nicolás Corral', 'corralnicolas3@gmail.com', '22-22222 2222', '2024-09-04', '222.222.222-22', 'são paulo', 'são paulo', 'cv_1726861366.pdf', 'video_1726861366.mp4', '9b871512327c09ce91dd649b3f96a63b7408ef267c8cc5710114e629730cb61f', '2024-09-26 00:00:00', 3);
...
--
-- Extraindo dados da tabela `interprete_documentos_temp`
--

INSERT INTO `interprete_documentos_temp` (`id`, `id_int`, `rg_frente`, `rg_verso`, `comp_resi`, `car_trabalho`, `ante_criminais`, `db1`, `db2`, `db3`, `data_hora`, `status`) VALUES
(3, 1, 'ff_1728041307.pdf', 'fv_1728041307.pdf', 'cr_1728041307.pdf', 'ct_1728041307.pdf', 'cac_1728041307.pdf', 'rere', 'rere', 'rere', '2024-10-04 08:28:27', 1);
...
--
-- Extraindo dados da tabela `interprete_perfil_temp`
--

INSERT INTO `interprete_perfil_temp` (`id`, `id_int`, `foto_perfil`, `video_apre`, `texto_apre`, `formacao`, `tempo_exp`, `genero`, `corRaca`, `data_hora`, `status`) VALUES
(5, 1, 'fp_1728041321.PNG', 'video_1728041321.1920x1080', 'gf', 'gfgf', 'm1', 'masculino', 'branca', '0000-00-00 00:00:00', 1);

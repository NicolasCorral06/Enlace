...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/11/2024 às 21:35
...
INSERT INTO `agendamento` (`id`, `id_servico`, `id_int`, `id_cli`, `preco`, `quantInt`, `quantHoras`, `cidade`, `codVerify`, `data`, `status`) VALUES
(2, 1, 1, 1, 100.00, 1, 1, 'São Paulo', 'rEuzCF5Ht', '2024-11-23', 3);
...
INSERT INTO `agendamentolocal` (`id`, `id_cli`, `cep`, `rua`, `numero`, `bairro`, `cidade`, `estado`, `codVerify`, `status`) VALUES
(2, 1, '04863000', 'Avenida Professora Marta Maria Bernardes', '202', 'Vila Natal', 'São Paulo', 'SP', 'rEuzCF5Ht', 3);

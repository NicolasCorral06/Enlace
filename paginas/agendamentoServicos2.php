...
<body>  
    ...
    <form action="../Adm/Controller/ageController.php" method="post">
        ...
        <select name="quantInt" id="quantInt">
        ...
        <select name="horaSer" id="horaSer">
            <option value=""> -- Selecione o tempo de evento -- </option>
        ...
        <div id="interpretesContainer">
            ...
            <select id="interprete" name="interprete" disabled>
                <option value="">-- Selecione uma cidade primeiro --</option> 
            </select><br><br>
        </div>
        
        <label for="data"> Selecione a data do serviço </label><br>
        <input type="date" name="data" id="data"><br><br>

        <input type="submit" value="Agendar">
    </form>

    <!-- a partir daqui de baixo e loucura minha, porfavor n mexer, eu n sei arrumar. Eu tava muito louco quando eu fiz isso -->
    <script>
    $(document).ready(function() {
            ...
            if (quantidade) {
                ...
                for (let i = 1; i <= quantidade; i++) {
                    container.append(`
                        ...
                        <select class="interprete" id="interprete${i}" name="interprete" data-index="${i}" disabled>
                            <option value="">-- Selecione uma cidade primeiro --</option>
                        </select>
                        <a href="" class="conheca-link" id="conhecaLink${i}" style="display:none" target="_blank">Conheça o intérprete</a>
                        <br><br>
                    `);
                }
            } else {
        ...
        $(document).on('change', '.interprete', function() {
            ...
            if (selectedValue) {
                ...
                $(`#conhecaLink${index + 1}`).attr('href', `detalhesInterprete.php?id=${selectedValue}`).show();
            } else {
        ...
        // Bloqueia a data anterior à data atual
        const hoje = new Date();

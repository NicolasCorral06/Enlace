...
<body>
    <div class="container-fluid">
        ...
        <div class="row rowCardAgendamentoGeral">
            <div class="col-4 colCardAgendamentoGeral">
                <div class="divCardAgendamentoGeral">
                    <b>Dia:</b> 7 de Setembro - Sábado <br><br><hr><br> 10:00 às 13:00
                </div>
            </div>    
            <div class="col-4 colCardAgendamentoGeral">
                <div class="divCardAgendamentoGeral">
                    <br>
                    Escolha os interpretes <br><br>
                    <select id="interpretes">
                        <option value="todos">Aleatório</option>
            ...
            <div class="col-4 colCardAgendamentoGeral">
                <div class="divCardAgendamentoGeral">
                    <b>Hora do Intérprete - R$100,00</b>
                    <br><hr>
                    <b>Total - R$600,00</b> <br>preço de 3 horas: R$300,00, com 2 intérpretes: R$600,00 (R$300,00 pra cada)
                </div>
            </div>

            <div class="col-10"></div>
            <div class="col-2 colButtonAgendamentoGeral">
                <a href="enderecoEvento.php"><button>Prosseguir</button></a>
            </div>
        </div>

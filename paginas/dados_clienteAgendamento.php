        ...
        <div class="row rowCardAgendamentoGeral">
            <div class="col-6 colCardAgendamentoGeral">
                <form action="#" method="post">
                    <div>
                        <label for="rua">Nome:</label><br>
                        <input type="text" id="rua" name="rua"><br>
                        <br>
                        <label for="numero">E-mail:</label><br>
                        <input type="number" id="numero" name="numero"><br>
                        <br>
                        <label for="cep">Número:</label><br>
                        <input type="text" id="cep" name="cep"><br>
                        <br>
                        <label for="bairro">CPF:</label><br>
                        <input type="text" id="bairro" name="bairro"><br>
                        <br>
                        <label for="cep">Cidade do cliente:</label><br>
                        <input type="text" id="cep" name="cep"><br>
                        <br>
                        <label for="cep">Estado do cliente:</label><br>
                        <input type="text" id="cep" name="cep"><br>
                        <br>
            ...
            <div class="col-2 colButtonAgendamentoGeral">
                <a href="pagamentoAgendamento.php"><button>Prosseguir</button></a>
            </div>
        </div>
